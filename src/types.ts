...
export interface Clinic {
  ...
  allowPrescriptionEdit?: boolean; // السماح/منع تعديل الروشتة بعد الحفظ والطباعة
  allowPrescriptionExternal?: boolean; // السماح/منع إضافة أدوية خارجية للروشتة
  clinicalSpecialty?: string; // التخصص السريري للعيادة (لتغيير نموذج الكشف)
  ...
  allowServerConfig?: boolean; // السماح للعيادة بإضافة/تعديل السيرفرات الخاصة بها
