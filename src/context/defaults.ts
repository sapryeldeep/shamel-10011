...
import { 
  ReportTemplate, User, Clinic, PatientQueueItem, Appointment, Expense, Drug, DiagnosisProtocol, Service, Department, 
...
export interface AppState {
  globalSystemMode: 'medical' | 'commercial';
  globalWhatsAppConfig: {
    enabled: boolean;
    defaultSenderNumber: string;
    allowClinicsToOverride: boolean;
  };
  customSpecialtyFieldsStore?: Record<string, any[]>;
  customReportTemplatesStore?: Record<string, ReportTemplate[]>;
