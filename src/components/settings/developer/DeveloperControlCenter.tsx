...
import DeveloperSpecialtyConfigTab from './DeveloperSpecialtyConfigTab';
...
export default function DeveloperControlCenter() {
  ...
  const validTabs: DeveloperTabType[] = [
    ...
    'system_updates', 'system_cloud', 'maintenance_health', 'clinical_config'
  ];
